...
def get_ken_french_factors(
    ...
    >>> df = get_ken_french_factors(factor_model="5", start_date="2020-01-01")
    """
    try:
        import pandas as pd
    ...
    if not isinstance(as_decimal, bool):
        raise ValueError("as_decimal must be a boolean.")
